      ...
      <div className="max-w-5xl w-full text-center space-y-16 z-10 animate-in fade-in duration-1000">
        <div className="space-y-10">
          <div className="flex justify-center">
            <div className="bg-[#ffe1a0]/10 p-6 rounded-full text-[#ffe1a0] border border-[#ffe1a0]/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-3xl mx-auto">
          <Link
            href="/admin"
            className="group bg-white/5 backdrop-blur-md p-10 border border-white/10 hover:border-[#ffe1a0] transition-all text-left flex flex-col"
          >
            <ShieldCheck size={28} className="text-[#ffe1a0] mb-8" />
            ...
            <div className="flex items-center text-[#ffe1a0] font-black text-[10px] uppercase tracking-[0.3em] group-hover:translate-x-2 transition-transform">
          ...
          <Link
            href="/client/project"
            className="group bg-[#ffe1a0] p-10 border border-transparent hover:bg-white transition-all text-left flex flex-col shadow-2xl"
          >
            <UserCircle size={28} className="text-[#0a0a0a] mb-8 group-hover:text-[#ffe1a0] transition-colors" />
